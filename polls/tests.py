...
def create_question(question_text, days):
    """ 
    Create a question with the given 'question_text' and publish the given numbers of 'days'
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Question With apub date in the future aren't displayed on the index page
        """
        create_question(question_text='Future Question.', days=30)
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, "No polls are avialble.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])


    def test_future_question_and_past_question(self):
        """
        Even if both future and past question exist only past questions are displayed
        """
        create_question(question_text='Past Question.', days=30)
        create_question(question_text='Future Question.', days=30)
        response = self.client.get(reverse('polls:index'))
...
class QuestionModelTest(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        test_was_publish_recently() return False for Questions 
    ...
    def test_was_publish_recently_with_old_question(self):
        """
        test_was_publish_recently() returns False for questions 
    ...
    def test_was_publish_recently_with_recent_question(self):
        # was test_was_publish_recently() returns True for questions 
        # whose pub_date is within the last 1 day
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of a Question with pub_date im the future returns 
        a 404 not found .
        """
